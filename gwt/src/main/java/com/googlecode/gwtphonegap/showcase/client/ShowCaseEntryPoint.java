...
public class ShowCaseEntryPoint implements EntryPoint {
    ...
    private List<IsWidget> getUserInterfaceRootWidgets(ClientFactory clientFactory) {
        ...
        if (MGWT.getOsDetection().isTablet()) {
            ...
            elementsToAdd = createTabletDisplay(clientFactory);
        } else {
            elementsToAdd = createPhoneDisplay(clientFactory);
        }
        return elementsToAdd;
    }

    private MGWTSettings buildMgwtSettings(ViewPort viewPort) {
    ...
    private ViewPort buildMgwtViewPort() {
    ...
    private List<IsWidget> createPhoneDisplay(ClientFactory clientFactory) {
    ...
    private List<IsWidget> createTabletDisplay(ClientFactory clientFactory) {
